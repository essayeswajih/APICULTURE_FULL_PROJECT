...
export class PopularProducts
  ...
  @ViewChild('popularSwiper')
  popularSwiper?: ElementRef<HTMLElement>;


  // 👇 References to the real buttons
  @ViewChild('popularPrevBtn')
  popularPrevBtn?: ElementRef<HTMLButtonElement>;

  @ViewChild('popularNextBtn')
  popularNextBtn?: ElementRef<HTMLButtonElement>;
  ...
  ngAfterViewInit(): void {
    ...
    const swiperEl =
      this.popularSwiper?.nativeElement as any;


    const prevButton =
      this.popularPrevBtn?.nativeElement;


    const nextButton =
      this.popularNextBtn?.nativeElement;
    ...
    Object.assign(swiperEl, {
      ...
      // 👇 IMPORTANT
      // Use the actual button elements
      navigation: {
