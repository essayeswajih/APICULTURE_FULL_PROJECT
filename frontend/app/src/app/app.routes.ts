...
export const routes: Routes = [
  ...
  {path: 'Conseils-Essentiels-pour-Bien-Demarrer-un-Rucher-en-Tunisie', loadComponent: () => import('./pages/blogs/debuteren-apiculture/debuteren-apiculture').then(m => m.DebuterenApiculture)},
  {path: 'Les-Meilleures-Pratiques-pour-Entretenir-vos-Abeilles-en-Ete-en-Tunisie', loadComponent: () => import('./pages/blogs/entretiendes-ruches/entretiendes-ruches').then(m => m.EntretiendesRuches)},
  {path: 'Les-Varietes-de-Miel-Tunisien-a-Decouvrir-et-Leurs-Bienfaits', loadComponent: () => import('./pages/blogs/bienfaitsdu-miel/bienfaitsdu-miel').then(m => m.BienfaitsduMiel)},
