...
/** Get all subcategories */
  getSubCategories(): Observable<SubCategory[]> {
    return this.http
      .get<SubCategory[]>(`${this.apiUrl}/subcategories`, { headers: this.getAuthHeaders() })
      .pipe(catchError(this.handleError));
  }
  ...
  addSubCategory(newSubCategory: SubCategory): Observable<SubCategory> {
    return this.http
      .post<SubCategory>(`${this.apiUrl}/subcategories`, newSubCategory, { headers: this.getAuthHeaders() })
      .pipe(catchError(this.handleError));
  }

  /** Update an existing subcategory */
  updateSubCategory(id: number, updatedSubCategory: SubCategory): Observable<SubCategory> {
    return this.http
      .put<SubCategory>(`${this.apiUrl}/subcategories/${id}`, updatedSubCategory, { headers: this.getAuthHeaders() })
      .pipe(catchError(this.handleError));
  }
  ...
  deleteSubCategory(id: number): Observable<void> {
    return this.http
      .delete<void>(`${this.apiUrl}/subcategories/${id}`, { headers: this.getAuthHeaders() })
      .pipe(catchError(this.handleError));
  }
  // ✅ Analytics (cards)
  getAnalytics(): Observable<any[]> {
    return this.http
      .get<any[]>(`${this.apiUrl}/analytics`, {
  ...
  getWeeklyIncome(): Observable<any> {
    return this.http
      .get<any>(`${this.apiUrl}/analytics/weekly-income`, {
        headers: this.getAuthHeaders()
      })
      .pipe(catchError(this.handleError));
  }
  ...
  getMonthlyStatus(): Observable<any> {
    return this.http
      .get<any>(`${this.apiUrl}/analytics/monthly-status`, {
        headers: this.getAuthHeaders()
      })
      .pipe(catchError(this.handleError));
  }
  getThisYearSales(): Observable<any> {
    return this.http
      .get<any>(`${this.apiUrl}/analytics/this-year-sales`, {
        headers: this.getAuthHeaders()
      })
      .pipe(catchError(this.handleError));
  }
  getTopProducts(period: 'week' | 'month'): Observable<any[]> {
    return this.http
      .get<any[]>(`${this.apiUrl}/analytics/top-products?period=${period}`, {
        headers: this.getAuthHeaders()
      })
      .pipe(catchError(this.handleError));
  }
